...
Sơ đồ tổng quan (chi tiết ở [trang 03](./03-architecture-overview)):
...
> Chi tiết flow này ở [trang 04](./04-windows-services-deep-dive).
...
**Tiếp theo:** [02 — Hướng dẫn vào Remote Desktop xem trên VPS →](./02-remote-desktop-guide)
