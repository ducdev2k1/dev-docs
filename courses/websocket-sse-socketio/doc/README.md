...
| 4   | [Socket.IO](./03-socketio-overview)                              | `03-socketio-overview.md`          |
| 5   | [Server-Sent Events (SSE)](./04-sse)                             | `04-sse.md`                        |
| 6   | [So sánh công nghệ](./05-comparison)                             | `05-comparison.md`                 |
| 7   | [Thiết kế kiến trúc](./06-architecture)                          | `06-architecture.md`               |
| 8   | [Testing & Debugging](./07-testing-debugging)                    | `07-testing-debugging.md`          |
| 9   | [Lộ trình học](./08-learning-path)                               | `08-learning-path.md`              |

### Bắt đầu

Nên bắt đầu từ **[1. Tổng quan & Nền tảng](./00-intro-overview)** để hiểu bối cảnh và hạn chế của HTTP, sau đó lần lượt WebSocket → Socket.IO → SSE.

Nếu bạn đã quen WebSocket, có thể nhảy thẳng tới **[5. Server-Sent Events (SSE)](./04-sse)** (có ví dụ BE + FE) hoặc **[4. Socket.IO](./03-socketio-overview)**.
